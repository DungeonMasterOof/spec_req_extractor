...
docker cp fedora:/app/build_requires.png /tmp
docker cp fedora:/app/runtime_requires.png /tmp
docker cp fedora:/app/build_requires /tmp
docker cp fedora:/app/runtime_requires /tmp
